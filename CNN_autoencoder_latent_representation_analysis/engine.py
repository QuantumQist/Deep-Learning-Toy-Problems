# -*- coding: utf-8 -*-
"""
Created on Wed Apr 24 17:18:08 2024
...
def train(model: torch.nn.Module, 
    ...
    device: A target device to compute on (e.g. "cuda" or "cpu").
    save_path: Path where model will be saved after each epoch
    model_mode: Defines the mode of operation of the model
    ...
    for epoch in tqdm(range(epochs)):
        ...
        # Save model
        model_file_name = f"epoch_{epoch+1}.pth"
        total_sava_path = model_path / model_file_name
        torch.save(obj=model.state_dict(), f=total_sava_path)
